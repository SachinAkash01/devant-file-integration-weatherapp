...
listener ftp:Listener WeatherListener = new (protocol = ftp:FTP, path = "/data/observations/metar/decoded/", port = 21, auth = {credentials: {username: ftpUser, password: ftpPassword}}, fileNamePattern = "(. * ).TXT", host = ftpHost, pollingInterval = 10);
